  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Relacionar palabras relacionadas con la automatización de pruebas
        p.mb-4 Identificar algunas palabras relacionadas con las especificaciones técnicas y pruebas de calidad de #[em software].
